document.addEventListener('DOMContentLoaded', () => {
    ...
    const artistData = [
        ...
        { name: 'Matheus & Kaun', image: './img/artista-mateus-kauan.jpg' },
    ];
    
    const albumsData = [
        { name: 'White Noise (Sleep & Relaxation Soounds)', artist: "Sleepy Jonh", image: './img/album-white-noise.jpg' },
        { name: 'O Céu Explica Tudo (Ao Vivo)', artist: "Henrique & Juliano", image: './img/album-ceu-explica.jpg' },
        { name: 'Nada como o dia apos o outro', artist: "Racionais", image: './img/album-racionais.jpg' },
